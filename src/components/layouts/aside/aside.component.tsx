...
const Aside = () =>
{
    ...
    const asideOpen = useAppSelector((state: { header: { asideOpen: any; }; }) => state.header.asideOpen);
    ...
    return (
        <aside className={classnames(styles.aside, { [styles.asideActive]: asideOpen })}>
            ...
            <div className={styles.asideFooter}>
                <a href='https://www.instagram.com/johnultimate/' target='_blank'>
                    <BsInstagram />
                </a>
                <a href='https://dribbble.com/johnultimate' target='_blank'>
                    <BsDribbble />
                </a>
                <a href='https://twitter.com/IntelligentQM' target='_blank'>
                    <BsTwitter />
                </a>
                <a href='https://github.com/SmartBlue0322' target='_blank'>
                    <BsGithub />
                </a>

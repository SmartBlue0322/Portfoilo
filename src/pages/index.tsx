...
const Home: NextPage = (props: any) =>
{
    ...
    return (
        <Fragment>
            <Head>
                <title>JohnUltimate &mdash; Full-Stack Developer</title>
            </Head>
...
{
    const repositories = await axios.get('https://api.github.com/users/SmartBlue0322/repos');
    const organizations = await axios.get('https://api.github.com/users/SmartBlue0322/orgs');

    ...
    return (
        <Fragment>
            <Head>
                ...
                <meta name='description' content='JohnUltimate Contact'/>
                <meta name='keywords' content='JohnUltimate, IQ, Quantum, Intelligent, Contact'/>
                <meta name='author' content='JohnUltimate'/>

                <meta property='og:type' content='website'/>
                <meta property='og:url' content='https://johnultimate.dev/contact'/>
                <meta property='og:title' content='JohnUltimate'/>
                <meta property='og:description' content='JohnUltimate Contact'/>
                <meta property='og:image' content='https://johnultimate.dev/favicon.png'/>

                <meta property='twitter:card' content='summary'/>
                <meta property='twitter:url' content='https://johnultimate.dev/contact'/>
                <meta property='twitter:title' content='JohnUltimate'/>
                <meta property='twitter:description' content='JohnUltimate Contact'/>

                <title>JohnUltimate &mdash; Contact with me</title>
            </Head>
                ...
                <div className={styles.contactCards}>
                    ...
                    <div className={styles.contactCardsCard}>
                        <ul className={styles.contactCardsCardList}>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Gmail:</span>
                                <a href="mailto:johnsmith010322@gmail.com">JohnUltimate</a>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>ProtonMail:</span>
                                <a href="mailto:johnsmith01322@proton.me">JohnUltimate</a>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Discord:</span>
                                <span></span>
